...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'photographer', 'videographer', 'photo-editor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Assignment', path: '/assignments', entity: 'assignment', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Media', path: '/media', entity: 'media', service: AccessServiceEnum.PROJECT, icon: FiFile },
    {
      name: 'Renamedpackage',
